        ...
        <div className="min-h-screen bg-gradient-to-br from-[#040508] via-[#0C0F15] to-[#040508] flex items-center justify-center p-4">
            <div className="w-full max-w-md">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-white/70">Sign in to your Second Brain Database account</p>
                ...
                <Card className="shadow-2xl border-0 bg-white/5 backdrop-blur-sm">
                    <CardHeader className="space-y-1 pb-4">
                        ...
                        <CardDescription className="text-center text-white/70">
                            Access your Second Brain Database
                        </CardDescription>
                    </CardHeader>
                    <CardContent>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        disabled={isLoading}
                                        className={`pl-10 h-11 transition-all duration-200 bg-white/10 border-white/20 text-white placeholder:text-white/50 ${errors.email ? 'border-red-300 focus:border-red-500' : 'border-white/20 focus:border-blue-500'
                                            }`}
                                    />
                                </div>
                                {errors.email && (
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        disabled={isLoading}
                                        className={`pl-10 pr-10 h-11 transition-all duration-200 bg-white/10 border-white/20 text-white placeholder:text-white/50 ${errors.password ? 'border-red-300 focus:border-red-500' : 'border-white/20 focus:border-blue-500'
                                            }`}
                                    />
                                    <button
                                        type="button"
